    ...
    <div className="relative flex flex-col items-center justify-center flex-grow bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-4 transition-colors duration-200">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center flex-grow px-4">
        <h1 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white font-serif tracking-wide">
          Sign in to <span className='font-mono text-blue-600 dark:text-blue-400 font-semibold'>invdues-reminder</span>
        </h1>
        <form
        ...
        >
          ...
          <div className="flex items-center justify-between">
            ...
            {error && <p className="text-red-500 text-sm mt-2 font-sans">{error.data?.message}</p>}
          </div>
        </form>
        <div className="flex flex-col items-center">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-white dark:bg-gray-800 border border-lime-100 hover:shadow-lime-300 hover:cursor-pointer text-gray-700 dark:text-gray-300 font-medium py-2 px-4 rounded shadow-md transform hover:scale-105 transition-all duration-200 font-sans"
          >
            Sign in with
